...
module.exports = class RemindCommand extends CommandClient.Command {
    constructor() {
        super({
            name: 'remind',
            ...
            args: [
                ...
                new Argument({ name: 'time', type: ArgumentType.Integer, required: true }),
                new Argument({ name: 'message', type: ArgumentType.String, required: true })]
        });
    }
    async run(msg, args) {
