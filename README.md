...
[_Docker Hub_](https://cloud.docker.com/u/matthewferderber/repository/docker/matthewferderber/co-bot)
...
You need to have your Discord Bot Token saved as an environment variable with the name DISCORD_BOT_TOKEN

You also need a League of Legends API key saved as an environment variable with the name LEAGUE_API_KEY
